...
{
    public class TranslateToGermanyKeyboardInputReceiver : TranslateKeyboardInputReceiverBase
    {
        ...
        public TranslateToGermanyKeyboardInputReceiver(ITranslationService translationService, IClipboardProxy clipboardService) : base(translationService, clipboardService)
        {
        }
    }
}